...
### Getting and Cleaning the Activity Dataset
...
### Calculating the mean and median steps taken per day  
**For the calculations, we summarize dataset with the very useful reshape2 package**
